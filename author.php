    ...
    <div class="container py-lg-4 py-md-3">
        ...
        <div class="row">
            <div class="col-lg-8 most-recent">
                <?php
                    $curauth = (isset($_GET['author_name'])) ? get_use('slug', $author_name) : get_userdata(intval($author));
                ?>
                <h3 class="section-title-left"> <?php echo $curauth->nickname; ?> : All Posts <?php echo get_the_author_posts(); ?></h3>
